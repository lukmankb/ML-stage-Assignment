...
print("Column names:", army.columns)
...
print("Third cell in the row named Arizona:", army.loc['Arizona'].iloc[2]) 
#Step 18. Select the third cell down in the column named deaths
print("Third cell down in the column named deaths:", army['deaths'].iloc[2]) 